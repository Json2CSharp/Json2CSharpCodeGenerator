...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_7_DuplictedClasses{
        ...
        public void Run()
        { 
        string path = Directory.GetCurrentDirectory().Replace("bin\\Debug", "")  + @"Test_7_DuplictedClasses_INPUT.txt";string resultPath =  Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_7_DuplictedClasses_OUTPUT.txt";            
