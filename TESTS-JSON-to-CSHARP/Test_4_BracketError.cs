...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_4_BracketError{
        ...
        public void Run()
        { 
        string path = Directory.GetCurrentDirectory().Replace("bin\\Debug", "")  + @"Test_4_BracketError_INPUT.txt";string resultPath =  Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_4_BracketError_OUTPUT.txt";            
