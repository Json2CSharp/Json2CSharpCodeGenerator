...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_18_WRONG_NAME_RECURSIVE_BUG78{
        ...
        public void Run()
        { 
            string path = Directory.GetCurrentDirectory().Replace("bin\\Debug", "")  + @"Test_18_WRONG_NAME_RECURSIVE_BUG78_INPUT.txt";
            string resultPath =  Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_18_WRONG_NAME_RECURSIVE_BUG78_OUTPUT.txt";            
