...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_6_DictionaryTest{
        ...
        public void Run()
        { 
        string path = Directory.GetCurrentDirectory().Replace("bin\\Debug", "")  + @"Test_6_DictionaryTest_INPUT.txt";string resultPath =  Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_6_DictionaryTest_OUTPUT.txt";            
