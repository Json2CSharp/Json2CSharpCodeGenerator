...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_1_5_SETTINGS_FIELDS_JSONPROPERTY
    {
        ...
        public void Run()
        {
            string path = Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_1_5_SETTINGS_FIELDS_JSONPROPERTY_INPUT.txt"; string resultPath = Directory.GetCurrentDirectory().Replace("bin\\Debug", "") + @"Test_1_5_SETTINGS_FIELDS_JSONPROPERTY_OUTPUT.txt";
