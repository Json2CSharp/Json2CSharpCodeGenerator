...
namespace TESTS_JSON_to_POJO
{
  ...
  public class Test_2_HANDLE_NUMBERS{
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_2_HANDLE_NUMBERS_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_2_HANDLE_NUMBERS_OUTPUT.txt");
        ...
        public void Run2()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_2_HANDLE_NUMBERS_INPUT1.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_2_HANDLE_NUMBERS_OUTPUT1.txt");
