...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_7_DuplictedClasses
    {
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_7_DuplictedClasses_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_7_DuplictedClasses_OUTPUT.txt");
