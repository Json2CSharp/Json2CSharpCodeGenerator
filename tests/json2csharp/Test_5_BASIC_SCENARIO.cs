...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_5_BASIC_SCENARIO{
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_5_BASIC_SCENARIO_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_5_BASIC_SCENARIO_OUTPUT.txt");
