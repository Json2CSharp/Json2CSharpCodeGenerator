...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_1_3_SETTINGS_FIELDS
    {
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_1_3_SETTINGS_FIELDS_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_1_3_SETTINGS_FIELDS_OUTPUT.txt");
