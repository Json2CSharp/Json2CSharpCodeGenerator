...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_9_HANDLE_NUMBERS{
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_9_HANDLE_NUMBERS_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_9_HANDLE_NUMBERS_OUTPUT.txt");
