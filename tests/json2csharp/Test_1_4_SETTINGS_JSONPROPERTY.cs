...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_1_4_SETTINGS_JSONPROPERTY
    {
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_1_4_SETTINGS_JSONPROPERTY_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_1_4_SETTINGS_JSONPROPERTY_OUTPUT.txt");
