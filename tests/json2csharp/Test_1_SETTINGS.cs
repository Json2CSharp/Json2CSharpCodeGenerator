...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_1_SETTINGS{
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_1_SETTINGS_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_1_SETTINGS_OUTPUT.txt");
