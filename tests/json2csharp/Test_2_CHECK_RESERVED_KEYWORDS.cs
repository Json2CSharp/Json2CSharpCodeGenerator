...
namespace TESTS_JSON_TO_CSHARP
{
  ...
  public class Test_2_CHECK_RESERVED_KEYWORDS{
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_2_CHECK_RESERVED_KEYWORDS_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_2_CHECK_RESERVED_KEYWORDS_OUTPUT.txt");
