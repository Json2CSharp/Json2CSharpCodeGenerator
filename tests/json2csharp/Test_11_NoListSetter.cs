...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_11_NoListSetter
    {
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_11_NoListSetter_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_11_NoListSetter_OUTPUT.txt");
