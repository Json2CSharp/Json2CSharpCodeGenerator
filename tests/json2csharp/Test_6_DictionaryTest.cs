...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_6_DictionaryTest
    {
        ...
        public void Run()
        {
            ...
            return;
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_6_DictionaryTest_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_6_DictionaryTest_OUTPUT.txt");
