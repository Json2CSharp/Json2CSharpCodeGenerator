...
namespace TESTS_JSON_TO_CSHARP
{
    ...
    public class Test_1_5_SETTINGS_FIELDS_JSONPROPERTY
    {
        ...
        public void Run()
        {
            string path       = Path.Combine(Environment.CurrentDirectory, "Test_1_5_SETTINGS_FIELDS_JSONPROPERTY_INPUT.txt");
            string resultPath = Path.Combine(Environment.CurrentDirectory, "Test_1_5_SETTINGS_FIELDS_JSONPROPERTY_OUTPUT.txt");
